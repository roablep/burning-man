...
1. **Run the full cohort pipeline**
   ```bash
   poetry run python src/census_next_gen_rs/scripts/census2025_cohort_all.py
   ```

2. **Open outputs**
   - Tables: `reports/census2025_cohort_retention.csv`
   - Trends: `reports/census2025_cohort_trends.csv`
   - Under-30 share: `reports/census2025_under30_share.csv`
   - Briefing prompt: `reports/census2025_cohort_analysis_briefing.md`
   - Visuals (Plotly HTML): `reports/figures/`
