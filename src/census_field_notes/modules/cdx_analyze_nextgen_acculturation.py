...
SCORES_FILENAME = "cdx_nextgen_acculturation_scores.csv"
VALIDATION_FILENAME = "cdx_nextgen_acculturation_validation.csv"
SUMMARY_FILENAME = "cdx_nextgen_acculturation_summary.md"
