...
async def run_analysis():
    ...
    # Pronoun Conclusion
    virgin_ratio = cohort_pronouns["Virgin"]["I"] / cohort_pronouns["Virgin"]["We"] if cohort_pronouns["Virgin"]["We"] > 0 else 0
    elder_ratio = cohort_pronouns["Elder"]["I"] / cohort_pronouns["Elder"]["We"] if cohort_pronouns["Elder"]["We"] > 0 else 0
